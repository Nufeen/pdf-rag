...
SEARCH_LANGUAGES: list[str] = [
    lang.strip() for lang in os.environ.get("SEARCH_LANGUAGES", "").split(",") if lang.strip()
]
TRANSLATE_MODEL: str = os.environ.get("TRANSLATE_MODEL", FAST_MODEL)
SERVER_URL: str = os.environ.get("PEDRO_SERVER_URL", "")
PDF_EXPORT_PATH: str = os.path.expanduser(os.environ.get("PEDRO_PDF_PATH", "~/.pedro/exports"))
