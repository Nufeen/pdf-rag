...
Pedro includes a custom evaluation framework to measure answer quality across different configurations (models, top_k, prompt variants). See [eval/README.md](eval/README.md) for usage.
